...
from rollo.archive_capability import (
    ARCHIVE_PREVIEW_CHARS,
    ToolResultArchiveCapability,
)
from rollo.archive_projection import (
...
from rollo.projections.model_replay_projection import ModelReplayResult
from rollo.projections.replay_metadata import ReplayMessageMeta
...
def test_agent_close_waits_for_active_provider_task_before_closing_owned_store(
    ...
    monkeypatch.setattr("rollo.agent.runtime_data_dir", lambda: tmp_path)
    ready = asyncio.Event()
