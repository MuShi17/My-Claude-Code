...
from mini_claude.runtime_ports import (
    NullOutputPort,
    OutputEvent,
    RecordingOutputPort,
    emit_safely,
)
from mini_claude.tests.tool_fixtures import FixtureToolbox
...
def test_敏感载荷标记可被检测() -> None:
    ...
    from mini_claude.runtime_ports import payload_is_safe
...
def test_port_failure_does_not_change_run_terminal_state() -> None:
    ...
    from mini_claude.run_lifecycle import RunStateGuard
...
def test_controllable_provider_fixture_shapes() -> None:
    ...
    from mini_claude.tests.provider_fixtures import ControllableProvider, ProviderFixtureToolbox
...
def test_real_run_emits_events_through_port_and_keeps_stdout_clean(
    ...
    from mini_claude.runtime_ports import payload_is_safe
    from mini_claude.tests.runtime_fixtures import assert_no_secrets
...
def test_real_subagent_run_events_keep_child_run_identity(
    ...
    monkeypatch.setattr(
        "mini_claude.agent.get_sub_agent_config",
