...
from mini_claude import ui
from mini_claude.runtime_ports import OutputEvent, RecordingOutputPort
from mini_claude.tui_adapter import TerminalInteractionPort, TerminalOutputPort
...
def test_cli_one_shot_constructs_both_terminal_ports(
    ...
    monkeypatch.setattr(sys, "argv", ["mini-claude", "hello"])
...
def test_cli_repl_main_constructs_both_terminal_ports(
    ...
    monkeypatch.setattr(sys, "argv", ["mini-claude"])
...
def test_terminal_interaction_port_reads_without_blocking_loop() -> None:
    ...
    from mini_claude.tui_adapter import TerminalInteractionPort
